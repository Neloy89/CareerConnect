                    ...
                    <div class="features-grid">
                        <div class="feature-card">
                            <div class="feature-icon" style="display:flex;align-items:center;justify-content:center;">
                                <img src="data:image/png;base64," alt="Smart Job Matching" style="width: 60px; height: 60px; border-radius: 50%; background: #f5f7fa; padding: 12px;">
                            </div>
                        ...
                        <div class="feature-card">
                            <div class="feature-icon" style="display:flex;align-items:center;justify-content:center;">
                                <img src="data:image/png;base64," alt="Track Your Applications" style="width: 60px; height: 60px; border-radius: 50%; background: #f5f7fa; padding: 12px;">
                            </div>
                        ...
                        <div class="feature-card">
                            <div class="feature-icon" style="display:flex;align-items:center;justify-content:center;">
                                <img src="data:image/png;base64," alt="Company Insights" style="width:60px;height:60px;border-radius:50%;background:#f5f7fa;padding:12px;">
                            </div>
            ...
            <section class="for-companies">
                <div class="container">
                    ...
                    <div class="company-benefits" style="display:flex;align-items:center;gap:32px;">
                        ...
                        <div class="company-image" style="flex:1;display:flex;justify-content:center;">
                            <img src="home_company.png" alt="For Companies" style="max-width:100%;max-height:300px;border-radius:16px;box-shadow:0 4px 20px rgba(0,0,0,0.08);border:4px solid #0A3D62;background:#1565c0;">
                        </div>
                    </div>
                </div>
            </section>
